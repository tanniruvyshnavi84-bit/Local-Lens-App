    ...
    <div className='bg-[#F6F9FC] text-gray-500/80 pt-8 px-6 md:px-16 lg:px-24 xl:px-32'>
            <div className='flex flex-wrap justify-between gap-12 md:gap-6'>
                <div className='max-w-80'>
                    ...
                    <p className='text-sm'>
                         Discover unique destinations and explore them with knowledgeable local guides for a truly authentic travel experience.
                    </p>
            ...
            <div className='flex flex-col md:flex-row gap-2 items-center justify-between py-5'>
                <p>© {new Date().getFullYear()} LocalLens. All rights reserved.<a href="https://prebuiltui.com">PrebuiltUI</a>. All rights reserved.</p>
