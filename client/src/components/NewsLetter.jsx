...
const NewsLetter = () => {
  return (
    <div className="flex flex-col items-center  max-w-5xl lg:w-full rounded-2xl px-4 py-12 md:py-16 mx-2 lg:mx-auto my-30 bg-gray-900 text-white">
            <Title title="Stay Connected" subTitle='Be part of LocalLens and discover new destinations, unique travel experiences, and curated insights from local guides.' />
